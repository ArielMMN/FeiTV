...
import model.Video;
import view.ListasReproducao;
 
import javax.swing.JOptionPane;
import java.sql.SQLException;
import java.util.List;
 
public class ControleListasReproducao {
 
    private ListasReproducao tela;
    private Usuario usuario;
 
    public ControleListasReproducao(ListasReproducao tela, Usuario usuario) {
        this.tela = tela;
